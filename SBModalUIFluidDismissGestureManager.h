...
@class NSString, SBAlertManager, SBAssistantController, SBHomeGestureSettings, SBModalUIFluidDismissGestureWorkspaceTransaction, SBScreenEdgePanGestureRecognizer;

@interface SBModalUIFluidDismissGestureManager : NSObject <SBSystemGestureRecognizerDelegate, BSTransactionObserver, _UISettingsKeyObserver>
{
    SBAlertManager *_alertManager;
    SBAssistantController *_assistantController;
    SBHomeGestureSettings *_homeGestureSettings;
    SBScreenEdgePanGestureRecognizer *_bottomEdgeRecognizer;
...
@property(retain, nonatomic) SBScreenEdgePanGestureRecognizer *bottomEdgeRecognizer; // @synthesize bottomEdgeRecognizer=_bottomEdgeRecognizer;
