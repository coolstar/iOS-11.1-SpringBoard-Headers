...
@interface SBLockScreenViewControllerBase : UIViewController <SBScreenWakeAnimationControllerDelegate, SBAutoUnlockRule, SBBiometricUnlockBehavior, SBButtonEventsHandler, SBApplicationHosting, SBIdleTimerProviding, SBScreenWakeAnimationTarget>
{
