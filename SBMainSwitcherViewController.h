...
@class BSAnimationSettings, FBDisplayLayoutElement, FBUIApplicationSceneDeactivationAssertion, NSMutableArray, NSMutableDictionary, NSString, SBAppLayout, SBAppSwitcherRemoteAlertSet, SBAppSwitcherServiceSet, SBAppSwitcherSettings, SBBestAppSuggestion, SBMainDisplayLayoutState, SBMainDisplaySceneLayoutViewController, SBOrientationTransformWrapperView, SBWindow, UIViewController<SBMainAppSwitcherContentViewControlling>;
